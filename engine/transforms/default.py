...
def get_image_transforms(args):
    ...
    if args.clip_encoder == 'ViT-B/16':
        train_transform = build_transform(args.img_augmentation)
        test_transform = build_transform('none')
    elif args.clip_encoder == 'RN50x16':
        train_transform = build_transform(args.img_augmentation, size=(384, 384))
        test_transform = build_transform('none', size=(384, 384))
