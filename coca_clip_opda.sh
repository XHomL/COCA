...
python coca.py --modality uni_modal --dataset domainnet --sourcepainting--target real --task OPDA
python coca.py --modality uni_modal --dataset domainnet --sourcepainting--target sketch --task OPDA
python coca.py --modality uni_modal --dataset domainnet --source real --targetpainting--task OPDA
python coca.py --modality uni_modal --dataset domainnet --source real --target sketch --task OPDA
python coca.py --modality uni_modal --dataset domainnet --source sketch --targetpainting--task OPDA
