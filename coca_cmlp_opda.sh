...
python coca.py --dataset domainnet --source painting --target real --task OPDA
python coca.py --dataset domainnet --source painting --target sketch --task OPDA
python coca.py --dataset domainnet --source real --target painting --task OPDA
python coca.py --dataset domainnet --source real --target sketch --task OPDA
python coca.py --dataset domainnet --source sketch --target painting --task OPDA
